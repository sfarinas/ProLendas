...
public class ComprarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                new RecyclerItemClickListener(
                        ...
                        new RecyclerItemClickListener.OnItemClickListener() {
                            ...
                            public void onItemClick(View view, int position) {
                                ...
                                Atleta atletaSelecionada = atletas.get(position);
                                Intent i = new Intent(ComprarActivity.this, CardapioActivity.class);
                                i.putExtra("atletas", atletaSelecionada);
                                startActivity(i);
        ...
        Toast.makeText(getApplicationContext(), "ComprarActivity", Toast.LENGTH_LONG).show();

    }

    private void pesquisarrAtleta(String pesquisa) {
    ...
    private void abrirConfiguracoes() {
        ...
        startActivity(new Intent(ComprarActivity.this, ConfiguracoesClubeActivity.class));
